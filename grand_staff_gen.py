...
from notation import easymode,tonal_triad,roman_numerial,inversion_type
...
# Example usage
question_data = simple_triad()
triad_notes = question_data["notes"]
chord_four_voices(triad_notes)
print(question_data["inversion_type"])
